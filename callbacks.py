...
def state_to_features(game_state: dict) -> np.array:
    ...
    *This is not a required function, but an idea to structure your code.*
    ...
    for index in n_nearest_coins_indizes:
        ...
        coin_features.append((x_coin - x_position) / (COLS - 1)) # so we have values between -1 and 1
        coin_features.append((y_coin - y_position) / (COLS - 1))
    ...
    # transform the values of field_of_view in the interval [-1, 1]
    field_of_view = -1 + 2/3 * (field_of_view + 2)
